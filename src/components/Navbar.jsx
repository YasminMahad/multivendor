  ...
  return (
    <nav className="w-screen  t-0 r-0 z-30 bg-[#e9f2f5] lg:justify-center  justify-between ">
         <div className="flex">
            ...
            <div className="justify-center items-center p-2 pl-3 ml-6">
                <p className=" flex justify-center items-center mt-3 "><FaRegStar className="text-2xl"/></p>
                <p className="text-sm">WhishList</p>
            </div>
            <div className="justify-center items-center p-2">
                <p className=" flex justify-center items-center mt-3"><BiGitCompare className="text-2xl"/></p>
                <p>Compare</p>
            </div>
            <div className="justify-center items-center p-2">
                <p className=" flex justify-center items-center mt-3"><AiOutlineShopping className="text-2xl"/></p>
                <p>Cart</p>
            </div>
            <div className="flex justify-start items-center ml-10">
                <AiOutlineUser className="text-4xl text-orange-500 flex justify-start"/>
                <div className="flex justify-center w-full">
                    <button className="mx-2 px-3 flex rounded-full bg-[#ec463093]">
                        Sign Up
                    </button>
                    <button className="mx-2 px-3 flex rounded-full bg-[#37f78dc9]">
                        Login
                    </button>
                </div>
            </div>
